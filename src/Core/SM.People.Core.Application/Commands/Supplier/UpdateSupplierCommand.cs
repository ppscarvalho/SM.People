...
{
    public class UpdateSupplierCommand : CommandHandler
    {
        ...
        public UpdateSupplierCommand(Guid id,
        ...
        {
            ValidationResult = new UpdateSupplierCommandValidation().Validate(this);
